...
import com.gkmonk.pos.model.attendance.AttendanceCheckinResponse;
...
public class AttendanceController {
    ...
    @PostMapping("/checkin")
    public ResponseEntity<AttendanceCheckinResponse> checkin(@RequestBody AttendanceCheckinRequest req) {
